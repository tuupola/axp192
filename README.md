...
You do not need to use `axp192_init()` first, you can also read and write without using the menuconfig settings, using the functions provided. Have a look at [m5core2_axp192](https://github.com/ropg/m5core_axp192) which provides device setup and some utility functions for the M5Core2 device using this driver for the communication with the AXP192.
